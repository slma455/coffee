...
for( var i of products.data){
  ...
  /* btn.addEventListener(addedToCart(i.id));*/
  /*
   btn.onclick = addedToCart(i.id);
    console.log(btn);
    */
...
/*
var cartProductDom =  document.querySelector(".carts-products");
 var quantity = document.querySelector(".quantity");
function addedToCart(id){
    let choosenItem = products.data.find((item) => item.id === id
    );
}
*/
